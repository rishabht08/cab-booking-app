...
//     r = setUnit(r > jQuery.CSS.filters[t].max ? jQuery.CSS.filters[t].max : r, jQuery.CSS.filters[t].unit),
//     e[n + "filter"] += i + "(" + r + ") ",
//     delete e[t]
// }
...
//         for (var r in t) {
//             "transform" === r && (t[jQuery.CSS.sfx + "transform"] = t[r],
//             delete t[r]),
//             "transform-origin" === r && (t[jQuery.CSS.sfx + "transform-origin"] = e[r],
//             delete t[r]),
//             "filter" !== r || jQuery.browser.mozilla || (t[jQuery.CSS.sfx + "filter"] = e[r],
//             delete t[r]),
...
//             var i = "";
//             "x" === r && (i = jQuery.CSS.sfx + "transform",
//             t[i] = t[i] || "",
//             t[i] += " translateX(" + setUnit(e[r], "px") + ")",
//             delete t[r]),
//             "y" === r && (i = jQuery.CSS.sfx + "transform",
//             t[i] = t[i] || "",
//             t[i] += " translateY(" + setUnit(e[r], "px") + ")",
//             delete t[r]),
//             "z" === r && (i = jQuery.CSS.sfx + "transform",
//             t[i] = t[i] || "",
//             t[i] += " translateZ(" + setUnit(e[r], "px") + ")",
//             delete t[r]),
//             "rotate" === r && (i = jQuery.CSS.sfx + "transform",
//             t[i] = t[i] || "",
//             t[i] += " rotate(" + setUnit(e[r], "deg") + ")",
//             delete t[r]),
//             "rotateX" === r && (i = jQuery.CSS.sfx + "transform",
//             t[i] = t[i] || "",
//             t[i] += " rotateX(" + setUnit(e[r], "deg") + ")",
//             delete t[r]),
//             "rotateY" === r && (i = jQuery.CSS.sfx + "transform",
//             t[i] = t[i] || "",
//             t[i] += " rotateY(" + setUnit(e[r], "deg") + ")",
//             delete t[r]),
//             "rotateZ" === r && (i = jQuery.CSS.sfx + "transform",
//             t[i] = t[i] || "",
//             t[i] += " rotateZ(" + setUnit(e[r], "deg") + ")",
//             delete t[r]),
//             "scale" === r && (i = jQuery.CSS.sfx + "transform",
//             t[i] = t[i] || "",
//             t[i] += " scale(" + setUnit(e[r], "") + ")",
//             delete t[r]),
//             "scaleX" === r && (i = jQuery.CSS.sfx + "transform",
//             t[i] = t[i] || "",
//             t[i] += " scaleX(" + setUnit(e[r], "") + ")",
//             delete t[r]),
//             "scaleY" === r && (i = jQuery.CSS.sfx + "transform",
//             t[i] = t[i] || "",
//             t[i] += " scaleY(" + setUnit(e[r], "") + ")",
//             delete t[r]),
//             "scaleZ" === r && (i = jQuery.CSS.sfx + "transform",
//             t[i] = t[i] || "",
//             t[i] += " scaleZ(" + setUnit(e[r], "") + ")",
//             delete t[r]),
//             "skew" === r && (i = jQuery.CSS.sfx + "transform",
//             t[i] = t[i] || "",
//             t[i] += " skew(" + setUnit(e[r], "deg") + ")",
//             delete t[r]),
//             "skewX" === r && (i = jQuery.CSS.sfx + "transform",
//             t[i] = t[i] || "",
//             t[i] += " skewX(" + setUnit(e[r], "deg") + ")",
//             delete t[r]),
//             "skewY" === r && (i = jQuery.CSS.sfx + "transform",
//             t[i] = t[i] || "",
//             t[i] += " skewY(" + setUnit(e[r], "deg") + ")",
//             delete t[r]),
//             "perspective" === r && (i = jQuery.CSS.sfx + "transform",
//             t[i] = t[i] || "",
...
//                 "function" == typeof u.CSSqueue && (u.CSSqueue(),
//                 u.CSSqueue = null)
//             }
//             var u = this
//               , a = jQuery(this);
...
//                 setTimeout(function() {
//                     a.one(jQuery.CSS.transitionEnd + "." + u.id, s),
//                     a.css(d)
//                 }, 1),
//                 u.timeout = setTimeout(function() {
//                     return u.called || !n ? (u.called = !1,
//                     void (u.CSSAIsRunning = !1)) : (a.css(jQuery.CSS.sfx + "transition", ""),
//                     n.apply(u),
//                     u.CSSAIsRunning = !1,
//                     void ("function" == typeof u.CSSqueue && (u.CSSqueue(),
//                     u.CSSqueue = null)))
//                 }, t + r + 10)
//             }
//         })
...
//                 l.updateSliderVal(),
//                 a.opt.readonly || (l.on(e.simpleSlider.events.start, function(e) {
...
//                   , n = e(l).outerHeight();
//                 l.x = "object" == typeof t ? t.clientX + document.body.scrollLeft - a.offset().left : "number" == typeof t ? t * i / l.opt.scale : l.opt.initialval * i / l.opt.scale,
//                 l.y = "object" == typeof t ? t.clientY + document.body.scrollTop - a.offset().top : "number" == typeof t ? (l.opt.scale - l.opt.initialval - t) * n / l.opt.scale : l.opt.initialval * n / l.opt.scale,
//                 l.y = a.outerHeight() - l.y,
//                 l.scaleX = l.x * l.opt.scale / i,
//                 l.scaleY = l.y * l.opt.scale / n,
//                 l.outOfRangeX = l.scaleX > l.opt.scale ? l.scaleX - l.opt.scale : l.scaleX < 0 ? l.scaleX : 0,
//                 l.outOfRangeY = l.scaleY > l.opt.scale ? l.scaleY - l.opt.scale : l.scaleY < 0 ? l.scaleY : 0,
//                 l.outOfRange = "h" == l.opt.orientation ? l.outOfRangeX : l.outOfRangeY,
//                 "undefined" != typeof t ? l.value = "h" == l.opt.orientation ? l.x >= a.outerWidth() ? l.opt.scale : l.x <= 0 ? 0 : l.scaleX : l.y >= a.outerHeight() ? l.opt.scale : l.y <= 0 ? 0 : l.scaleY : l.value = "h" == l.opt.orientation ? l.scaleX : l.scaleY,
//                 "h" == l.opt.orientation ? l.level.width(o(l.x, i) + "%") : l.level.height(o(l.y, n)),
